      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link to="/" className="hover:text-miraj-gold hover:pl-2 transition-all block">Home</Link></li>
              <li><Link to="/movies" className="hover:text-miraj-gold hover:pl-2 transition-all block">Movies</Link></li>
              <li><Link to="/tv" className="hover:text-miraj-gold hover:pl-2 transition-all block">TV Shows</Link></li>
              <li><Link to="/sports" className="hover:text-miraj-gold hover:pl-2 transition-all block">Live Sports</Link></li>
              <li><Link to="/live" className="hover:text-miraj-gold hover:pl-2 transition-all block">Live TV</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link to="/faq" className="hover:text-miraj-gold hover:pl-2 transition-all block">FAQ</Link></li>
              <li><Link to="/contact" className="hover:text-miraj-gold hover:pl-2 transition-all block">Contact Us</Link></li>
              <li><Link to="/about" className="hover:text-miraj-gold hover:pl-2 transition-all block">About Us</Link></li>
              <li><Link to="/request" className="hover:text-miraj-gold hover:pl-2 transition-all block">Request Content</Link></li>
            </ul>
          </div>
           ...
           <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link to="/privacy" className="hover:text-miraj-gold hover:pl-2 transition-all block">Privacy Policy</Link></li>
              <li><Link to="/terms" className="hover:text-miraj-gold hover:pl-2 transition-all block">Terms of Service</Link></li>
              <li><Link to="/dmca" className="hover:text-miraj-gold hover:pl-2 transition-all block">DMCA</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm text-center md:text-left whitespace-nowrap">
            © {new Date().getFullYear()} UwatchFree Stream. All rights reserved.
          </p>
