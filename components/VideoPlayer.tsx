...
//     standard: 'brightness(1) contrast(1) saturate(1) sepia(0) hue-rotate(0deg)',
//     cinema: 'contrast(1.2) saturate(1.1) brightness(0.9)',
...
//             {/* Centered Top Control Bar */}
//             <div className="absolute top-0 inset-x-0 p-3 sm:p-4 md:p-6 bg-gradient-to-b from-black/90 via-black/40 to-transparent pointer-events-auto">
...
//                         <button 
//                           onClick={() => router.back()} 
//                           className="p-1.5 sm:p-2 bg-black/60 backdrop-blur-md rounded-full border border-white/10 hover:bg-miraj-red text-white transition-all shadow-lg flex-shrink-0"
//                           aria-label="Go back"
//                         >
//                             <ArrowLeft size={16} className="sm:w-5 sm:h-5"/>
//                         </button>
//                         <div className="truncate min-w-0">
//                             <p className="text-[10px] font-bold text-miraj-gold tracking-widest uppercase">
//                               {type === 'sports' ? 'LIVE SPORTS' : 
//                                type === 'tv_live' ? 'LIVE TV' : 
//                                type.toUpperCase()}
//                             </p>
//                             <h4 className="text-white text-xs font-bold truncate max-w-[150px] sm:max-w-[200px] md:max-w-xs">{title}</h4>
//                         </div>
//                     </div>

//                     {/* CENTERED CONTROLS */}
//                     <div className="flex items-center gap-1.5 sm:gap-2 bg-black/40 backdrop-blur-xl p-1.5 rounded-full border border-white/10 shadow-2xl w-full sm:w-auto justify-between sm:justify-center">
//                         {streams.length > 1 && (
//                             <div className="relative flex-1 sm:flex-none">
//                                 <select 
//                                   value={activeServer} 
//                                   onChange={(e) => setActiveServer(Number(e.target.value))} 
//                                   className="bg-transparent text-white text-[10px] sm:text-[11px] font-black border-none rounded-full py-1.5 pl-3 pr-6 sm:pr-8 focus:outline-none appearance-none cursor-pointer uppercase tracking-tighter w-full"
...
//                                     ))}
//                                 </select>
//                                 <ChevronDown size={10} className="sm:w-3 sm:h-3 absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 text-miraj-gold pointer-events-none" />
//                             </div>
//                         )}
...
//                           className="p-1.5 sm:p-2 bg-black/60 backdrop-blur-md rounded-full border border-white/10 hover:text-miraj-gold text-white transition-all shadow-lg flex-shrink-0"
...
//                     <div className="hidden sm:block min-w-[150px] flex-1 sm:flex-none"></div>
//                 </div>
//             </div>
//         </div>
...
//                 <div className="w-10 h-10 sm:w-12 sm:h-12 border-4 border-white/5 border-t-miraj-gold rounded-full animate-spin mb-3 sm:mb-4"/>
//                 <span className="text-miraj-gold text-xs font-bold tracking-[0.3em] animate-pulse px-4 text-center">
...
//                 <AlertCircle size={40} className="sm:w-12 sm:h-12 text-miraj-red mb-3 sm:mb-4" />
...
//                     className="bg-miraj-gold text-black px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-bold hover:bg-yellow-500 transition-colors text-sm sm:text-base"
//                   >
