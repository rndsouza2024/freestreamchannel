...
//   // Updated ONLY where realistic iframe impact is meaningful
//   const filterPresets: Record<string, string> = {
//   standard: 'brightness(1) contrast(1) saturate(1)',
//   hdr: 'brightness(1.05) contrast(1.25) saturate(1.2)',
//   vivid: 'brightness(1.1) contrast(1.3) saturate(1.35)',
//   cinema: 'brightness(0.95) contrast(1.25) saturate(0.85) sepia(0.08)',
//   sharp: 'brightness(1.05) contrast(1.45) saturate(1.05)',
//   gaming: 'brightness(1.05) contrast(1.3) saturate(1.45)',
//   // sports: 'brightness(1.12) contrast(1.3) saturate(1.4)',
//   sports: 'brightness(1.15) contrast(1.25) saturate(1.5)',
//   night: 'brightness(0.9) contrast(1.2) saturate(0.85)',
//   bw: 'grayscale(100%) contrast(1.25)',
//   };
...
//     const item = sourceData.find((m) => m.id.toString() === tmdbId.toString());
    
//     // Auto-generate embed streams if no specific source data found (Fallback for Clone functionality)
//     if (!item || !item.streams) {
//         if (type === 'movie') {
//             return [
//                 { id: 'srv-1', name: 'Server 1', url: `https://xprime.today/watch/${tmdbId}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-2', name: 'Server 2', url: `https://cinemaos.tech/player/${tmdbId}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-3', name: 'Server 3', url: `https://zxcstream.xyz/player/movie/${tmdbId}/english?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-4', name: 'Server 4', url: `https://www.cinezo.net/watch/movie/${tmdbId}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-5', name: 'Server 5', url: `https://vidsrc-embed.ru/embed/movie/${tmdbId}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-6', name: 'Server 6', url: `https://api.cinezo.net/embed/tmdb-movie-${tmdbId}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-7', name: 'Server 7 - HINDI', url: `https://zxcstream.xyz/player/movie/${tmdbId}/hindi?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
...
//         if (type === 'tv') {
//              return [
//                 { id: 'srv-1', name: 'Server 1', url: `https://zxcstream.xyz/player/tv/${tmdbId}/s=${season}/e=${episode}/english?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-2', name: 'Server 2', url: `https://xprime.today/watch/${tmdbId}/${season}/${episode}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-4', name: 'Server 4', url: `https://api.cinezo.net/embed/tmdb-tv-${tmdbId}/${season}/${episode}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-5', name: 'Server 5', url: `https://www.cinezo.net/watch/tv/${tmdbId}?season=${season}&episode=${episode}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-6', name: 'Server 6 - HINDI', url: `https://zxcstream.xyz/player/tv/${tmdbId}/s=${season}/e=${episode}/hindi?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
//              ] as StreamSource[];
//         }
//     }
...
//   const TopControls = () => (
//     <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 pointer-events-auto w-full px-2">
//         {/* Title Badge */}
//         <div className="hidden sm:flex items-center gap-2 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10 shadow-lg">
...
//     return (
//         <div className="flex items-center gap-2 overflow-x-auto pb-2 no-scrollbar w-full mt-2 px-2 md:justify-center">
//             {streams.map((s, i) => (
//                 <button
//                     key={s.id}
//                     onClick={() => setActiveServer(i)}
//                     className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all whitespace-nowrap border ${activeServer === i ? 'bg-miraj-gold text-black border-miraj-gold shadow-[0_0_15px_rgba(251,191,36,0.5)]' : 'bg-black/50 text-gray-300 border-white/10 hover:border-miraj-gold hover:text-white'}`}
//                 >
//                     <Server size={14} />
...
//       <div className="absolute top-0 left-0 right-0 p-2 sm:p-4 z-40 transition-opacity duration-300 opacity-0 group-hover:opacity-100 bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
...
//                 { id: 'srv-5', name: 'Server 5', url: `https://www.cinezo.net/watch/tv/${tmdbId}?season=${season}&episode=${episode}`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-6', name: 'Server 6 - HINDI', url: `https://zxcstream.xyz/player/tv/${tmdbId}/s=${season}/e=${episode}/hindi?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
//                 { id: 'srv-7', name: 'Server 7', url: `https://vidsrc-embed.ru/embed/tv/${tmdbId}/${season}/${episode}`, quality: 'HD', type: 'iframe' },
//              ] as StreamSource[];
//         }
//     }
...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
    ...
    if (!item || !item.streams) {
        ...
        if (type === 'tv') {
             return [
                { id: 'srv-1', name: 'Server 1', url: `https://zxcstream.xyz/player/tv/${tmdbId}/s=${season}/e=${episode}/english?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
                { id: 'srv-2', name: 'Server 2', url: `https://xprime.today/watch/${tmdbId}/${season}/${episode}`, quality: 'HD', type: 'iframe' },
                { id: 'srv-3', name: 'Server 3', url: `https://api.cinezo.net/embed/tmdb-tv-${tmdbId}/${season}/${episode}`, quality: 'HD', type: 'iframe' },
                { id: 'srv-4', name: 'Server 4', url: `https://www.cinezo.net/watch/tv/${tmdbId}?season=${season}&episode=${episode}`, quality: 'HD', type: 'iframe' },
                // { id: 'srv-6', name: 'Server 6 - HINDI', url: `https://zxcstream.xyz/player/tv/${tmdbId}/s=${season}/e=${episode}/hindi?autoplay=false&back=true&server=0`, quality: 'HD', type: 'iframe' },
                { id: 'srv-5', name: 'Server 5', url: `https://vidsrc-embed.ru/embed/tv/${tmdbId}/${season}/${episode}`, quality: 'HD', type: 'iframe' },
             ] as StreamSource[];
        }
    }
  ...
  // Reset active server ONLY when the media item changes (Movie A -> Movie B)
  useEffect(() => {
    setActiveServer(0);
  }, [tmdbId, type]);

  // Handle cleanup on prop change (including season/episode), but PERSIST server selection
  useEffect(() => {
    setIsLoading(true);
    setPlayerError(false);
  ...
  useEffect(() => {
    // Safety check: If for some reason streams changed and index is out of bounds, reset.
    // This handles rare edge cases where Season 2 might have fewer servers than Season 1.
    if (streams.length > 0 && activeServer >= streams.length) {
        setActiveServer(0);
        return;
    }
