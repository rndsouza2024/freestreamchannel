...
const Contact: React.FC = () => {
  ...
  const schema = {
    ...
    "@type": "ContactPage",
    "name": "Contact UwatchFreeOfficial",
    "description": "Get in touch with the UwatchFreeOfficial team for support, requests, or DMCA inquiries.",
    "url": "https://uwatchfree-official.vercel.app/contact"
  };

  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO 
        title="Contact Us - UwatchFreeOfficial" 
        description="Get in touch with the UwatchFreeOfficial team." 
        schema={schema}
        path="/contact"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1 space-y-6">
                <div className="bg-miraj-gray border border-white/5 p-6 rounded-xl">
                    ...
                    <a href="mailto:support@UwatchFreeOfficial.com" className="text-miraj-red hover:underline font-medium">support@UwatchFreeOfficial.com</a>
                </div>
                ...
                <div className="bg-miraj-gray border border-white/5 p-6 rounded-xl">
                    ...
                    <a href="mailto:legal@UwatchFreeOfficial.com" className="text-miraj-red hover:underline font-medium">legal@UwatchFreeOfficial.com</a>
                </div>
            </div>
