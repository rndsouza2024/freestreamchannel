...
const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO title="About Us - UwatchFree Stream" description="Learn more about UwatchFree Stream, the best place to watch movies and TV shows online." />
      
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        <div className="text-center mb-12">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">About <span className="text-miraj-red">UwatchFree Stream</span></h1>
        ...
        <div className="bg-miraj-gray border border-white/5 rounded-2xl p-6 md:p-10 mb-8">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
                At UwatchFree Stream, our mission is simple: to provide a seamless, high-quality, and accessible streaming experience for entertainment lovers worldwide. 
