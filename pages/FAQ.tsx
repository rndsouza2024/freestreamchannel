...
const FAQ: React.FC = () => {
  const faqs = [
    {
      question: "Is UwatchFreeOfficial free to use?",
      answer: "Yes, UwatchFreeOfficial is completely free to use. You can watch movies, TV shows, and live channels without paying any subscription fees."
    },
    {
    ...
    },
    {
      ...
      answer: "UwatchFreeOfficial operates as a search engine for streaming links. We DO NOT host nor transmit any audiovisual content itself and DO NOT control nor influence such content. We cannot accept any liability for the content transmitted by others."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO 
        title="Frequently Asked Questions - UwatchFreeOfficial" 
        description="Find answers to common questions about UwatchFreeOfficial, streaming, and our service." 
        schema={schema}
        path="/faq"
      />
