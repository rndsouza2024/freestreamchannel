...
export const UNIQUE_SPORTS: MediaItem[] = [
  {
    ...
    release_date: getRelativeTime(8, 30), 
    vote_average: 9.2,
    duration: "Live",
    media_type: 'sports',
  ...
  },
  {
    ...
    duration: "Live",
    media_type: 'sports',
    genres: ["Soccer", "El Clasico"],
    streams: {
      "Server 1 (Main)": "https://daddyhd.com/stream/stream-346.php",
      "Server 2 (Backup)": "https://daddyhd.com/stream/stream-347.php",
      "Server 3 (Spanish)": "https://daddyhd.com/stream/stream-348.php",   
    },
    overview: "El Clasico Live. The biggest match in world football.",
  },
  {
    id: "match-night-test",
    ...
    streams: {
      "Server 1 (USA)": "https://daddyhd.com/stream/stream-346.php",
      "Server 2 (Intl)": "https://daddyhd.com/stream/stream-347.php",
    },
    overview: "Western Conference showdown. Check timezone logic: 11:30 PM UTC -> GMT+2 should be Next Day.",
  },
  {
    id: "match-early-test",
    ...
    genres: ["Racing", "F1"],
    streams: {
      "Server 1 (Sky Sports)": "https://daddyhd.com/stream/stream-13.php",
      "Server 2 (Onboard)": "https://daddyhd.com/stream/stream-14.php",
    },
    overview: "Live form Suzuka. Check timezone logic: 1AM UTC Tomorrow -> GMT-5 should be Today.",
  },
  {
    id: "match-ended-1",
    ...
    genres: ["MMA", "UFC"],
    streams: {
      "Server 1 (Replay)": "https://daddyhd.com/stream/stream-665.php",
      "Server 2 (Highlights)": "https://daddyhd.com/stream/stream-666.php",
    },
